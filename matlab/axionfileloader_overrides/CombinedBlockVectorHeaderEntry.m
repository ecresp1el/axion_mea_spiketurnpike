    ...
    methods(Static)
        function obj = Deserialize(aEntryRecord, aFileID)
            ...
            if(fReadCRC ~= fCalcCRC)
                warning( ...
                    'AxionFileLoader:BlockVectorMetaDataChecksum', ...
                    'BlockVectorMetaData checksum was incorrect. Continuing for metadata-only inspection.');
            end
            ...
            if(fSize ~= fBlockVectorMetadataReadSize)
                warning( ...
                    'AxionFileLoader:UnexpectedBlockVectorMetaDataLength', ...
                    ['Unexpected BlockVectorMetadata length. ' ...
                     'Continuing for metadata-only inspection.']);
            end
